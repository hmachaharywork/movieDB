...
import { IMAGE_BASE_URL, ALT_IMAGE_BASE_URL } from '../utils/utility';
        ...
        return (
          <Col className="movie-thumnail" key={movie.id} xs={12} sm={6} md={6} lg={4}>
              ...
              <div className="movie-property">
                <div className="movie-release"><i className="fa fa-calendar" aria-hidden="true"></i> {movie.release_date}</div>
